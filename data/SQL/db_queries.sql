-- Check All Imported CSV files can be properly read
...
--
-- Begin Query Analysis of the db
--
...
SELECT dept_emp.emp_no, employees.emp_no, employees.last_name, employees.first_name, departments.dept_name
FROM employees
JOIN dept_emp ON employees.emp_no = dept_emp.emp_no
...
-- Epilogue (Guess it was all a joke Haha)
SELECT * FROM employees
WHERE emp_no = '499942';
